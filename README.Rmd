...
## Demo files
You can see a list of all the demonstration files using:
```{r, eval=FALSE}
demo(package="BCWaterDischargeAnalysis")
```

You can run a specific demo using:
```{r, eval=FALSE}
demo("sample-analysis", package="BCWaterDischargeAnalysis")
```
