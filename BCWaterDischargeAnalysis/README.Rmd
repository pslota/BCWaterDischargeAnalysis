...
in the [vignette](https://htmlpreview.github.com/?https://github.com/bcgov/water-discharge-analysis/master/vignettes/example-analysis.html). In your R session, you can type `vignette("BCWaterDischargeAnalysis")` to see the vignette.
...
---------|-------------
Date   | The data of the reading in standard R date class format. For example to convert a 4-digit year, numeric month, and numeric day of the month use __as.Date{paste(df$Year,'-',df$Month,'-',df$Day,sep="")}__.
