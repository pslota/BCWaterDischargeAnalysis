...
in the [vignette](https://htmlpreview.github.com/?https://github.com/bcgov/water-discharge-analysis/master/inst/doc/example-analysis.html). In your R session, you can type `vignette("BCWaterDischargeAnalysis")` to see the vignette.
...
month use __as.Date{paste(df$Year,'-',df$Month,'-',df$Day,sep="")}__.
