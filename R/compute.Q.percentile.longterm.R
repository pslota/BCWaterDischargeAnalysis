...
#'   \item{file.stat.csv}{Object with file name of *.csv file with percentile statistics.}
#'    \item{file.stat.trans.csv}{Object with file name of *.csv file with transposed percentile statistics.}
